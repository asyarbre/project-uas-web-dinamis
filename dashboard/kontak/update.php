    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        if ($_SERVER["REQUEST_METHOD"] == "POST") {
          ...
          $contact_to = input($_POST["contact_to"]);
        ...
        <div class="container-fluid">
          <!-- Page Heading -->
          <h1 class="h3 mb-4 text-gray-800">Update Data kontak</h1>
          <form class="col-lg-6" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group">
              <label>Kontak Ke:</label>
              <input type="text" name="contact_to" class="form-control" placeholder="Kontak Ke..." value="<?php echo $data["contact_to"]; ?>" required />
            </div>
            <div class="form-group">
              <label>Link :</label>
              <input type="text" name="link" class="form-control" placeholder="Masukan Link" value="<?php echo $data["link"]; ?>" required />
            </div>
