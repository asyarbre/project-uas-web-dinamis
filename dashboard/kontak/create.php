    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        if ($_SERVER["REQUEST_METHOD"] == "POST") {
          ...
          $sql = "insert into kontak (title,desk,contact_to,link) values ('$title','$desk','$contact_to','$link')";
        ...
        <div class="container-fluid">
          <!-- Page Heading -->
          <h1 class="h3 mb-4 text-gray-800">Add Data kontak</h1>
          <form class="col-lg-6" action="<?php echo $_SERVER["PHP_SELF"]; ?>" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group">
              ...
              <input type="text" name="contact_to" class="form-control" placeholder="Kontak ke ...." required />
            </div>
            <div class="form-group">
              <label>Link:</label>
