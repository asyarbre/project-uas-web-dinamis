    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        if ($_SERVER["REQUEST_METHOD"] == "POST") {
          ...
          $sql = "insert into gabung (title,desk,gambar,posisi_gambar) values ('$title','$desk','$gambar','$posisi_gambar')";
        ...
        <div class="container-fluid">
          <!-- Page Heading -->
          <h1 class="h3 mb-4 text-gray-800">Add Data Gabung</h1>
          <form class="col-lg-6" action="<?php echo $_SERVER["PHP_SELF"]; ?>" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group">
              ...
              <textarea class="form-control" name="desk" placeholder="Masukan Deskripsi" rows="5" required></textarea>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
              ...
              <select class="custom-select" name="posisi_gambar">
                ...
                <option value="md:flex-row-reverse">Kanan</option>
