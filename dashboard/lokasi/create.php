    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        if ($_SERVER["REQUEST_METHOD"] == "POST") {
          ...
          $sql = "insert into lokasi (nama,alamat,preview_map) values ('$nama','$alamat','$gambar')";
        ...
        <div class="container-fluid">
          <!-- Page Heading -->
          <h1 class="h3 mb-4 text-gray-800">Add Data lokasi</h1>
          <form class="col-lg-6" action="<?php echo $_SERVER["PHP_SELF"]; ?>" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group">
              <label>Upload Preview Map</label>
