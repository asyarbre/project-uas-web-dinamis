    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        if ($_SERVER["REQUEST_METHOD"] == "POST") {
          ...
          $sql = "insert into bisnis (title,desk,gambar,posisi_gambar) values ('$title','$desk','$gambar','$posisi_gambar')";
        ...
        <div class="container-fluid">
          <!-- Page Heading -->
          <h1 class="h3 mb-4 text-gray-800">Add Data Bisnis</h1>
          <form class="col-lg-6" action="<?php echo $_SERVER["PHP_SELF"]; ?>" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group">
              ...
              <input type="text" name="desk" class="form-control" placeholder="Masukan Deskripsi" required />
            </div>
            <div class="form-group">
